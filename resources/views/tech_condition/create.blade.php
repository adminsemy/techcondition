...
<div class="container-fluid">
    <div class="row">
        <div class="card-body">
            <form method="POST" id="Create" action="{{ route('techCondition.store') }}">
                @csrf
                <div class="form-group row">
                    <label for="TU-1" class="col-md-1 col-form-label text-md-right">{{ __('messages.TechCondition_Number_1') }}</label>

                    <div class="col-md-1">
                        <input id="TU-1" type="text" class="form-control @error('TU-1') is-invalid @enderror" name="TU-1" value="{{ old('TU-1') }}" autocomplete="TU-1" autofocus>
                    ...
                    <div class="col-md-1">
                        <input id="TU-2" type="text" class="form-control @error('TU-2') is-invalid @enderror" name="TU-2" value="{{ old('TU-2') }}" autocomplete="TU-2" autofocus>
                    ...
                    <div class="col-md-1">
                        <input id="DataTU" type="text" class="form-control @error('DataTU') is-invalid @enderror" name="DataTU" value="{{ old('DataTU') }}" autocomplete="DataTU" autofocus>
                    ...
                    <div class="col-md-5">
                        <select class="custom-select form-control @error('CodZakazchika') is-invalid @enderror" id="CodZakazchika"  name="CodZakazchika">
                            @foreach($customers as $customer)
                                @if ($customer->id === old('CodZakazchika'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <input id="NZayavki" type="text" class="form-control @error('NZayavki') is-invalid @enderror" name="NZayavki" value="{{ old('NZayavki') }}" autocomplete="NZayavki" autofocus>
                    ...
                    <div class="col-md-1">
                        <input id="DataZayavki" type="text" class="form-control @error('DataZayavki') is-invalid @enderror" name="DataZayavki" value="{{ old('DataZayavki') }}" autocomplete="DataZayavki" autofocus>
                    ...
                    <div class="col-md-5 offset-md-3">
                      <select class="custom-select form-control @error('CodPodrazdelenia') is-invalid @enderror" id="CodPodrazdelenia"  name="CodPodrazdelenia">
                          @foreach($units as $unit)
                              @if ($unit->id === old('CodPodrazdelenia'))
