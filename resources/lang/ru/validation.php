...
return [
    ...
    'Imya.not_regex' => 'В поле ' . __('messages.First_name_name') . ' не должны использоваться пробелы',
    'Imya.string' => 'Поле ' . __('messages.First_name_name') . ' должно быть строковым параметром',
